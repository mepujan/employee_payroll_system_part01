...
public class payrollTester {
	...
	public static void main(String[] args) {
		...
		SalariedEmployee salaryEmp1 = new SalariedEmployee("Joe","Francis","123456789",2500);
		
		SalariedEmployee salaryEmp2 = new SalariedEmployee("Samantha","Hughes","444555666",1400);
		salaryEmp2.setManager(salaryEmp1);
		
		HourlyEmployee hourlyEmp = new HourlyEmployee("Kim","Adams","888999000",18.50,42);
		hourlyEmp.setManager(salaryEmp1);
		
		ComissionEmployee comissionEmp = new ComissionEmployee("Rayan","GoodAll","111222333",10,9000);
